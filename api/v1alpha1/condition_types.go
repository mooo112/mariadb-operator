...
const (
	...
	// ConditionTypeMultiClusterPrimarySwitched indicates whether a cluster-level switchover has completed.
	ConditionTypeMultiClusterPrimarySwitched string = "MultiClusterPrimarySwitched"
	...
	// ConditionReasonSwitchMultiClusterPrimary indicates that a cluster-level switchover is the reason for the condition.
	ConditionReasonSwitchMultiClusterPrimary string = "SwitchMultiClusterPrimary"
